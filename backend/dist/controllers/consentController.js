...
const submitConsent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const consent = yield consentService.submitConsent(userId, type, Boolean(agreed), version, source, metadata, ip_address, user_agent);
